...
public class DrawLineTool extends JButton implements MouseListener, MouseMotionListener
{
    ...
    public DrawLineTool(DrawingBoard _board)
    {
        super("Line");
        board = _board;
    ...
    {
        //Sends the drawn line through the network
        board.sendCanvas();
    }
    ...
    public void mouseDragged(MouseEvent e) 
    {
        ...
        //Clears the image by drawing the old saved copy, then draws a new line.
